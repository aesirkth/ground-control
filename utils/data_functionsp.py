...
def f0x96(ser):
    return [
        Data("flight", "pressure_1", ser.read_int(4)) * 100,
        Data("flight", "temperature_1", ser.read_int(4)) * 100,
        Data("flight", "pressure_2", ser.read_int(4)) * 100,
        Data("flight", "temperature_2", ser.read_int(4) * 100)
    ]
...
def f0x99(ser):
    bat1_raw = ser.read_int(2) * 100
    bat2_raw = ser.read_int(2) * 100 
...
def f0x9A(ser):
    return [
        Data("flight", "ext_temp_1", ser.read_int(2) * 100),
        Data("flight", "ext_temp_2", ser.read_int(2) * 100)
    ]
